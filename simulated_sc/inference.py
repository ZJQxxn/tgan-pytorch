...
for epoch in range(start_epoch, opt['epochs']):
    ...
    dis_loss_history.append(loss.data.item())
    gen_loss_history.append(gen_loss.data.item())
    real_loss_history.append(d_real_loss.data.item())
    MSE_history.append(mse)
    correlation_hostory.append(corr)
